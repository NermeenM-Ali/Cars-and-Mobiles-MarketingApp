        ...
        return(
           <View style={{flex:1}}>
                ...
                <View style={{ flex: 10, flexDirection: 'column', backgroundColor: 'white' }}>
                    ...
                    <View style={{ position: 'absolute', top: 0, left: 0, right: 0, height: hp(45) }}>
                        <Image source={require('../assets/Imgs/Mb19.jpg')} />
                    </View>

                    <View style={{marginTop:hp(3) ,position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: 'white', height: hp(53) }}>
                      <ScrollView>
                        <Container>
                            <Content>
                                <List>
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='I-6 3,0 l' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.power} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='362 hp @ 6,100 rpm (270 kW)' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                                    ...
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='9 Speeds' fontSize={wp(4)} color={color.TEXT_COLOR}/>     
                                    </ListItem>
                    ...
                    <View style={{flexDirection:'row' ,position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: color.TEXT_COLOR, height: hp(7) }}>
                        <Button  onPress={()=>{ 
                               ...
                               this.props.AddToCart(Strings.merceds19) 
                        ...
                        <AppText text={`${Strings.EGP} 850,200`} fontSize={wp(5)} color={color.MAIN_COLOR} marginLeft={wp(5)} marginVertical={hp(1)}/>
                    </View>
                </View>
           </View>
        )
...
export default connect(mapStateToProps, mapDispatchToProps)(MB19)
