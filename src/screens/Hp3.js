           ...
           <View style={{flex:1}}>
                ...
                <Swiper autoplay={false} loop={false} showsButtons={false} style={{ position: 'absolute', top: 0, left: 0, right: 0, height: hp(50)}}>
                            <View style={{alignItems:'center',justifyContent:'center'}}>
                                <Image source={require('../assets/Imgs/hp3.jpg')} style={{ width:wp(100), height:hp(50)}} />
                            </View>

                            <View style={{alignItems:'center',justifyContent:'center'}}>
                                <Image source={require('../assets/Imgs/hp3-2.jpg')} style={{marginTop:hp(10), width:wp(100), height:hp(50), marginLeft:hp(15)}} />
                            </View>
                            ...
                            <Content>
                                <List>
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='HP Laptop 15.6 Inch' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.processor} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='Intel® Core™i3' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                                    ...
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='4 GB' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                    ...
                    <Button  onPress={()=>{ 
                               ...
                               this.props.AddToCart(Strings.hp3) 
                        ...
                        <AppText text={`${Strings.EGP} 6,399`} fontSize={wp(5)} color={color.MAIN_COLOR} marginLeft={wp(5)} marginVertical={hp(1)}/>
                    </View>
                </View>
           </View>
        )
...
export default connect(mapStateToProps, mapDispatchToProps)(Hp3)
