...
class Oppof9 extends Component {
    render() {
           ...
           <View style={{flex:1}}>
                ...
                <Swiper autoplay={false} loop={false} showsButtons={false} style={{ position: 'absolute', top: 0, left: 0, right: 0, height: hp(50)}}>
                            <View style={{alignItems:'center',justifyContent:'center'}}>
                                <Image source={require('../assets/Imgs/oppof9.jpg')} style={{marginTop:hp(10)}} />
                            </View>
                            ...
                            <Content>
                                <List>
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='OppoF9' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.processor} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='Mediatek MT6771 Helio P60 ' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.screen} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='6.3 inches' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.camera} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='Dual rear 16, front 25 ' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.operatingSystem} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='Android 8.1 Oreo' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                                    ...
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='3500mAh' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.colors} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='Blue' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                    ...
                    <View style={{flexDirection:'row' ,position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: color.TEXT_COLOR, height: hp(7) }}>
                        <Button  onPress={()=>{ 
                               ...
                               this.props.AddToCart(Strings.oppof9) 
                        ...
                        <AppText text={`${Strings.EGP} 5,250`} fontSize={wp(5)} color={color.MAIN_COLOR} marginLeft={wp(5)} marginVertical={hp(1)}/>
                    </View>
                </View>
           </View>
        )
...
export default connect(mapStateToProps, mapDispatchToProps)(Oppof9)
