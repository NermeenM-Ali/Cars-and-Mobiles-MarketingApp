           ...
           <View style={{flex:1}}>
                ...
                <Swiper autoplay={false} loop={false} showsButtons={false} style={{ position: 'absolute', top: 0, left: 0, right: 0, height: hp(50)}}>
                            <View style={{alignItems:'center',justifyContent:'center'}}>
                                <Image source={require('../assets/Imgs/iphoneXs.jpg')} style={{marginTop:hp(10)}} />
                            </View>
                            ...
                            <Content>
                                <List>
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='iphoneXs-max' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.processor} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text=' Hexa-core Apple A12 Bionic' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                                    ...
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text=' Dual 12 + 12 MP Rear / Front 7 MB' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.operatingSystem} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='iOS 12' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                                    ...
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='3174 mAh' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.colors} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='White, Black, Gold' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                    ...
                    <View style={{flexDirection:'row' ,position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: color.TEXT_COLOR, height: hp(7) }}>
                        <Button  onPress={()=>{ 
                               ...
                               this.props.AddToCart(Strings.iphoneXs) 
                        ...
                        <AppText text={`${Strings.EGP} 21000`} fontSize={wp(5)} color={color.MAIN_COLOR} marginLeft={wp(5)} marginVertical={hp(1)}/>
                    </View>
                </View>
           </View>
        )
...
export default connect(mapStateToProps, mapDispatchToProps)(IphoneXs)
