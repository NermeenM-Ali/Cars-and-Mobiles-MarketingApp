           ...
           <View style={{flex:1}}>
                ...
                <Swiper autoplay={false} loop={false} showsButtons={false} style={{ position: 'absolute', top: 0, left: 0, right: 0, height: hp(50)}}>
                            <View style={{alignItems:'center',justifyContent:'center'}}>
                                <Image source={require('../assets/Imgs/dell3.jpg')} style={{marginTop:hp(10),width:wp(70), height:hp(30)}} />
                            </View>

                            <View style={{alignItems:'center',justifyContent:'center'}}>
                                <Image source={require('../assets/Imgs/dell3-2.jpg')} style={{marginTop:hp(10),width:wp(70), height:hp(30)}} />
                            </View>
                            ...
                            <Content>
                                <List>
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='Dell Inspiron 15 3576' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                    ...
                    <View style={{flexDirection:'row' ,position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: color.TEXT_COLOR, height: hp(7) }}>
                        <Button  onPress={()=>{ 
                               ...
                               this.props.AddToCart(Strings.dell3) 
                        ...
                        <AppText text={`${Strings.EGP} 5,899`} fontSize={wp(5)} color={color.MAIN_COLOR} marginLeft={wp(5)} marginVertical={hp(1)}/>
                    </View>
                </View>
           </View>
        )
...
export default connect(mapStateToProps, mapDispatchToProps)(Dell3)
