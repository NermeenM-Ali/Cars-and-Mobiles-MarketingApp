           ...
           <View style={{flex:1}}>
                ...
                <Swiper autoplay={false} loop={false} showsButtons={false} style={{ position: 'absolute', top: 0, left: 0, right: 0, height: hp(50)}}>
                            <View style={{alignItems:'center',justifyContent:'center'}}>
                                <Image source={require('../assets/Imgs/dell7.jpg')} style={{marginTop:hp(5),width:wp(100), height:hp(30)}} />
                            </View>

                            <View style={{alignItems:'center',justifyContent:'center'}}>
                                <Image source={require('../assets/Imgs/dell7-2.jpg')} style={{marginTop:hp(10),width:wp(70), height:hp(30)}} />
                            </View>
                            ...
                            <Content>
                                <List>
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='Dell G5 15 - 5587' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                                    ...
                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText text='16 GB DDR4' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.HardDrive} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='1 TB + 256 GB SSD' fontSize={wp(4)} color={color.TEXT_COLOR}/>     
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.operatingSystem} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='Ubuntu Linux 16.04' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>

                                    <ListItem style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={Strings.dimensions} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText text='389 x 274.7 x 24.95mm' fontSize={wp(4)} color={color.TEXT_COLOR}/>
                                    </ListItem>
                    ...
                    <View style={{flexDirection:'row' ,position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: color.TEXT_COLOR, height: hp(7) }}>
                        <Button  onPress={()=>{ 
                               ...
                               this.props.AddToCart(Strings.dell7) 
                        ...
                        <AppText text={`${Strings.EGP} 23,199`} fontSize={wp(5)} color={color.MAIN_COLOR} marginLeft={wp(5)} marginVertical={hp(1)}/>
                    </View>
                </View>
           </View>
        )
...
export default connect(mapStateToProps, mapDispatchToProps)(Dell7)
